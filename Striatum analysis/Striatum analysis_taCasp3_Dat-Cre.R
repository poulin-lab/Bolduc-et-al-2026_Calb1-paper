...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/Striatal spectra/Dat-ires-Cre/CSVfiles")
...
for (i in 1:nfiles) {
  ...
  setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/Striatal spectra/Dat-ires-Cre/Noise")
...
df$Group <- gsub('CoffFon-taCasp3', 'CoffFontaCasp3', df$Group)
...
unique(df[df$Group == "ConFontaCasp3",]$MouseID)

#Extract the bacthes of immuno
Batch1_NotaCasp3 <- rbind(NotaCasp3[NotaCasp3$MouseID == c("G0917"),],
                          NotaCasp3[NotaCasp3$MouseID == c("H0214"),],
                          NotaCasp3[NotaCasp3$MouseID == c("H0263"),],
                          NotaCasp3[NotaCasp3$MouseID == c("H0386"),],
                          NotaCasp3[NotaCasp3$MouseID == c("H0572"),],
                          NotaCasp3[NotaCasp3$MouseID == c("H0573"),]
                          )


Batch1_CoffFontaCasp3 <- rbind(CoffFontaCasp3[CoffFontaCasp3$MouseID == c("G0918"),],
                               CoffFontaCasp3[CoffFontaCasp3$MouseID == c("H0215"),],
                               CoffFontaCasp3[CoffFontaCasp3$MouseID == c("H0383"),],
                               CoffFontaCasp3[CoffFontaCasp3$MouseID == c("H0384"),],
                               CoffFontaCasp3[CoffFontaCasp3$MouseID == c("H0387"),]
)

#Extract the bacthes of immuno
Batch1_ConFontaCasp3 <- rbind(ConFontaCasp3[ConFontaCasp3$MouseID == c("G0919"),],
                              ConFontaCasp3[ConFontaCasp3$MouseID == c("H0216"),],
                              ConFontaCasp3[ConFontaCasp3$MouseID == c("H0265"),],
                              ConFontaCasp3[ConFontaCasp3$MouseID == c("H0382"),],
                              ConFontaCasp3[ConFontaCasp3$MouseID == c("H0385"),],
                              ConFontaCasp3[ConFontaCasp3$MouseID == c("H0388"),]
)

Batch1 <- rbind(Batch1_NotaCasp3, Batch1_CoffFontaCasp3, Batch1_ConFontaCasp3)
...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/Striatal spectra/Dat-ires-Cre/Stats")
