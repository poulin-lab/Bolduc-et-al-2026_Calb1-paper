...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/taCasp3_Batch/Unilateral/Batch3")
#------------------------------------------------------------------------------
...
#Note: The value I got for this batch one pixel is equivalent to 0.0437cm, or 0.437mm
Resolution <- 0.437
...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/taCasp3_Batch/Unilateral/Batch3/Output")
...
#------------------------------------------------------------------------
#Save all the bouts
saveRDS(All_Bouts, file = "All_Bouts_taCasp3_Batch3.rds")
