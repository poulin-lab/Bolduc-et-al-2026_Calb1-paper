...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/DREADD/Batch2")
#------------------------------------------------------------------------------
...
#Note: The value I got for this batch one pixel is equivalent to 0.0447cm, or 0.447mm
Resolution <- 0.447
...
for (n in 1:nfiles) {
  ...
  setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/DREADD/Batch2/Ouput")
...
saveRDS(Bouts_Amplitude, "BoutsAmplitude_DREADD_Batch2.rds")
