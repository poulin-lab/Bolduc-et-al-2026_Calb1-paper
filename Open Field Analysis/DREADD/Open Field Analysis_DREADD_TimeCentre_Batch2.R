...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/DREADD/Batch2/TimeCentre_Output")
...
#Export to csv
write.csv(Perc_Centre, "DREADD_Batch2_OpenField_%Centre.csv")
