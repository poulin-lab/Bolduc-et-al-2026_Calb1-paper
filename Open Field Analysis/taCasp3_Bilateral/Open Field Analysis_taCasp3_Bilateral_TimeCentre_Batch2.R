...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/taCasp3_Batch/Bilateral/Batch2/TimeCentre_Output")
...
#Export to csv
write.csv(Perc_Centre, "taCasp3Bilateral_Batch2_OpenField_%Centre.csv")
