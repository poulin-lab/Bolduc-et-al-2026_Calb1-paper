...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/taCasp3_Batch/Bilateral/Batch1")
#------------------------------------------------------------------------------
...
setwd("C:/Users/cyril/OneDrive - McGill University (1)/Documents/PhD/Raw data/OpenField_Velocity Analysis/taCasp3_Batch/Bilateral/Batch1/TimeCentre_Output")
...
#Note: The pValue is significant for NotaCasp3 and ConFon-taCasp3, so non-paramteric Kruskal-Wallis test will be used

res.kruskal <- Toplot %>% kruskal_test(Perc_Centre ~ Group)
res.kruskal
#Note: the pValue was significant

# Pairwise comparisons
pwc <- Toplot %>% 
  dunn_test(Perc_Centre ~ Group, p.adjust.method = "bonferroni") 
pwc
#Note: Pairwise comparisons using the Dunn's test revealed no significant differences accross the groups